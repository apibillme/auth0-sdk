...
// Signup - sign up user
func Signup(email string, password string, connection string, userMetadata string) (gjson.Result, error) {
...
func ChangePassword(email string, password string, connection string) (gjson.Result, error) {
...
func UserInfo(accessToken string) (gjson.Result, error) {
...
func ChallengeMFA(mfaToken string, challengeType string) (gjson.Result, error) {
...
func VerifyOTP(mfaToken string, otpCode string) (gjson.Result, error) {
	url := auth0DomainGlobal + `/oauth/token`
...
func VerifyOOB(mfaToken string, oobCode string, bindingCode string) (gjson.Result, error) {
	url := auth0DomainGlobal + `/oauth/token`
...
func VerifyRecoveryCode(mfaToken string, recoveryCode string) (gjson.Result, error) {
	url := auth0DomainGlobal + `/oauth/token`
...
func AddAuthenticator(authenticatorTypes []string, oobChannels string, phoneNumber string) (gjson.Result, error) {
...
func Passwordless(connection string, email string, phoneNumber string, send string, authParams string) (gjson.Result, error) {
...
func CreateClientGrant(body string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clientGrants
	return restlyPostJSON(req, url, body, "")
}

// DeleteClientGrant - delete a client grant
func DeleteClientGrant(id string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clientGrants + `/` + id
	return restlyDeleteJSON(req, url, "")
}

// UpdateClientGrant - update client grant
func UpdateClientGrant(id string, body string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clientGrants + `/` + id
	return restlyPatchJSON(req, url, body, "")
}

// GetClients - get all clients
func GetClients(query string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clients
	return restlyGetJSON(req, url, query)
}

// CreateClient - create a client
func CreateClient(body string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clients
	return restlyPostJSON(req, url, body, "")
}

// GetClient - get a client
func GetClient(id string, query string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clients + `/` + id
	return restlyGetJSON(req, url, query)
}

// DeleteClient - delete a client
func DeleteClient(id string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clients + `/` + id
	return restlyDeleteJSON(req, url, "")
}

// UpdateClient - update a client
func UpdateClient(id string, body string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + clients + `/` + id
	return restlyPatchJSON(req, url, body, "")
}

// RotateClientSecret - rotate the client secret
func RotateClientSecret(id string) (gjson.Result, error) {
...
func UpdateGuardianEnrollmentTemplates(body string) (gjson.Result, error) {
	url := auth0DomainGlobal + mgmtAPIVersion + guardianFactors + `/sms/templates`
	return restlyPutJSON(req, url, body, "")
}

// GetGuardianSNSConfig - get guardian AWS SNS factor provider configuration
func GetGuardianSNSConfig() (gjson.Result, error) {
...
func GetGuardianTwilioConfig() (gjson.Result, error) {
...
func ImportUsers(query string) (gjson.Result, error) {
